...
public class MainShelter {
	...
	public static void main(String[] args) throws IOException {
		...
		// ******* Testowe zwierzaki ********* //
		Animal rex = new Animal(1, "Rex", 2);
		Animal burek = new Animal(2, "Burek", 7);
		Animal burek2 = new Animal(15, "Mario", 1);
		//animalList.add(burek);
		//animalList.add(burek2);
		//animalList.add(rex);
			...
			case "status":
				...
				if (noOfAnimals != 0) {
					for (Animal singleAnimal : animalList) {
						System.out.println(animalList.indexOf(singleAnimal)+ " "+" id: " + singleAnimal.getId() + " name: " + singleAnimal.getName() + " age: "
								+ singleAnimal.getAge());
					}
